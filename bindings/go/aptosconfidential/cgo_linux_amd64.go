...
/*
#cgo CFLAGS: -I${SRCDIR}/native/x86_64-unknown-linux-gnu
#cgo LDFLAGS: ${SRCDIR}/native/x86_64-unknown-linux-gnu/libaptos_confidential_asset_ffi.a -ldl -lpthread -lm
